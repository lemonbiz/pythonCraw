...
def get_photos(url,new_fpath):
    print('2222')
    result = get_url(url)
                               #https://images.pexels.com/photos/414171/pexels-photo-414171.jpeg?h=350&auto=compress&cs=tinysrgb
                               #https://images.pexels.com/photos/547116/pexels-photo-547116.jpeg?h=350&amp;auto=compress&amp;cs=tinysrgb" 
                               #https://images.pexels.com/photos/262669/pexels-photo-262669.jpeg?h=350&amp;auto=compress&amp;cs=tinysrgb" 
...
def main():  
    ...
    fpath = 'D://learning//webCrawler//picture//'  
    for i in range(num):  
